...
#import "RFTestDemoUITests-Swift.h"

@interface RFTestDemoUITests : XCTestCase

@end

@implementation RFTestDemoUITests
...
- (void)testNextView {
    ...
    [Snapshot snapshot:@"02LoginScreen" timeWaitingForIdle:0];
